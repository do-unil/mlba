...
\normalsize
\begin{center}
\includegraphics[width=6cm]{../../Graphs/BreastCancerLongTree.png}
\end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
...
\begin{center}
\includegraphics[width=7cm]{../../Graphs/BreastCancer_CPs.png}
\end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
...
\begin{center}
\includegraphics[width=7cm]{../../Graphs/BreastCancerShortTree.png}
\end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%\begin{column}{0.5\textwidth}
%\vspace{1.5cm}
%\includegraphics[width=5cm]{../../Graphs/IRIS_CART_CP.png}
%\end{column}
%\end{columns}
%\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
