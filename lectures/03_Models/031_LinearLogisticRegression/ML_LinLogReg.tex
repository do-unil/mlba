...
\vspace{0.2cm}
Also, a model with a lot of predictions close to 0.5 is considered as poor because of its uncertainty\footnote{A little thought on that will brings us back to the entropy.}.
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
