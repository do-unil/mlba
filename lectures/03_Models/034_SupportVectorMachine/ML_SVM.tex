...
\normalsize
\begin{center}
\includegraphics[width=4cm]{../../Graphs/SVM_radial1.png} 
\includegraphics[width=4cm]{../../Graphs/SVM_radial2.png} \\
\includegraphics[width=4cm]{../../Graphs/SVM_radial3.png} 
\includegraphics[width=4cm]{../../Graphs/SVM_radial4.png} 
\end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
...
\normalsize
\begin{center}
\includegraphics[width=4cm]{../../Graphs/SVM_cost1.png} 
\includegraphics[width=4cm]{../../Graphs/SVM_cost2.png} \\
\includegraphics[width=4cm]{../../Graphs/SVM_cost3.png} 
\includegraphics[width=4cm]{../../Graphs/SVM_cost4.png} 
\end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Final words}
...
\includegraphics[width=6cm]{../../Graphs/SVM_iris.png} 
\end{column}
\end{columns}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
