...
\begin{enumerate}
\item Select at random a training set by sampling from the original data base, {\it with replacements}, and {\it of the same size}.
...
$$
Note: this optimization is always at the cost of a lower accuracy.
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]
\frametitle{Tuning probability threshold}
