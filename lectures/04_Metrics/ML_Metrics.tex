...
\item Metrics for binary classifications only (e.g., precision, sensitivity, specificity, $F_1$)
\end{itemize}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]
...
\begin{frame}[fragile]
\frametitle{The $R^2$}
In the ML context, the $R^2$ ({\bf $R$ squared}) is sometimes computed as the square of the correlation between the observations and the predictions.
$$
R^2 = cor(y,f(x;\theta))^2
$$
