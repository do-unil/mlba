...
\begin{itemize}
\item Its origin and/or source (not only the web page from which it was retieved).
...
\vspace{0.3cm}
Most functions in {\tt R} handle these representations automatically. However, it is not always the case in {\tt Python} or in other computer programs. In any case, it is important to know what is behind the scene and how to represent categorical variables as dummy variables.
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
...
\item Can bias the analysis: e.g., missing is linked to the outcome (MNAR)
\end{itemize}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
