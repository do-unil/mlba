...
predictions to the true outcomes.\
**Unsupervised learning** aims to analyze the link between the features.
There is no "supervisor". Unsupervised methods can be separated in two
main ones:
