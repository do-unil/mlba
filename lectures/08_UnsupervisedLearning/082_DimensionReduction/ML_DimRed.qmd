...
![](../../Graphs/Iris_raw.pdf){width="11cm" fig-align="center"}
...
![](../../Graphs/Iris_raw2.pdf){width="10cm" fig-align="center"}
...
![](../../Graphs/Iris_pca.pdf){width="7cm" fig-align="center"}
...
![](../../Graphs/Iris_pcacircle.pdf){width="10cm" fig-align="center"}
...
![](../../Graphs/Iris_cos2.pdf){width="8cm" fig-align="center"}

The **biplot** shows a **map of the individuals** in the dimensions and
adds the circle of correlations.

![](../../Graphs/Iris_biplot.pdf){width="9cm" fig-align="center"}
...
![](../../Graphs/Iris_scree.pdf){width="9cm" fig-align="center"}
...
![](../../Graphs/FAMD_screeplot.pdf){width="7cm" fig-align="center"}

The plots of the contributions shows the contributions of each variable
(Length and Width) to the dimensions (1 and 2).

0.55 ![](../../Graphs/FAMD_contrib_xy.pdf){width="6cm" fig-align="center"}

0.45 ![](../../Graphs/FAMD_contrib_x.pdf){width="4.5cm" fig-align="center"}\
![](../../Graphs/FAMD_contrib_y.pdf){width="4.5cm" fig-align="center"}

The plot of the modalities locates the modalities of each variable on
the map of the dimensions.

![](../../Graphs/FAMD_quali.pdf){width="7cm" fig-align="center"}
...
![](../../Graphs/Iris_AE_embed.pdf){width="9cm" fig-align="center"}
...
![](../../Graphs/Iris_AE_VImp1.pdf){width="5cm" fig-align="center"}
![](../../Graphs/Iris_AE_VImp2.pdf){width="5cm" fig-align="center"}
![](../../Graphs/Iris_AE_VImp3.pdf){width="5cm" fig-align="center"}
