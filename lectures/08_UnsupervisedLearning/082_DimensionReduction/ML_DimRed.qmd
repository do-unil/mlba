...
is made on the interpretation and its use for dimensional reduction. One must pay attention to the subtleties of different interpretations between the part of numerical features (PCA) and the one for categorical features (MCA).
...
by variance but by the **inertia**. Because proportions sum up to 1, there are $(3-1)\times (3-1) = 4$ possible dimensions.

The scree plot shows the percentage of inertia explained by each
dimension.

![](../../Graphs/FAMD_Screeplot.png){width=40% fig-align="center"}

The plots of the contributions shows the contributions of each variable
(Length and Width) to the dimensions (1 and 2).

![](../../Graphs/FAMD_contrib_xy.png){width=40% fig-align="center"}

![](../../Graphs/FAMD_contrib_x.png){width=40% fig-align="center"}

![](../../Graphs/FAMD_contrib_y.png){width=40% fig-align="center"}

The plot of the modalities locates the modalities of each variable on
the map of the dimensions.

![](../../Graphs/FAMD_quali.png){width=40% fig-align="center"}
...
![](../../Graphs/FAMD_biplot_species.png){width=70% fig-align="center"}
