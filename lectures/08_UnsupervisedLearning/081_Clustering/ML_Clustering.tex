...
\begin{itemize}
\item The {\bf K-means} (Lloyd, 1957).
...
\end{enumerate}
The K-means is suitable for {\bf numerical features only}. The Euclidean distance is often used. A sequential version (by MacQueen, 1967) assigns observations using K intial observations is not presented here.
...
\end{center}
Clusters 1 and 3 are well formed, Clusters 2 and 4 are less homogeneous.
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%
