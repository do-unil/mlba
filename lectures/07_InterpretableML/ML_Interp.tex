...
\item Around case 3: same as Case 1.
\end{itemize}

The exploration of these cases suggests an important and consistent directional effect of duration (low values push toward label 0, higher values toward label 1). A similar analysis can be conducted for contact = cellular, housing = yes, etc.
...
The exploration does not reveal any meaningful local behavior for campaign, as its contributions are consistently small and unstable across cases. The fact that Case 3 has a probability around 0.5 makes it interesting. \\
