...
[^1]: GitHub is a code hosting platform for collaboration and version control. You *do not need* to learn about GitHub for this class, *however* it is also where our open-source textbook is hosted so we're asking you to make an account on GitHub to be able to provide feedback on the book.
