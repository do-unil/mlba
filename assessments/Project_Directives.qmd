...
The final grade is the grade of the project that splits into two parts:  the report (incl. codes and supplementary material) counts for 70% and the presentation (incl. slides) counts for 30%. Grades are rounded to the closest 0.1. The final grade is rounded to the closest 0.5. 
