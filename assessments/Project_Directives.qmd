...
The size of groups is 3 students. You may now register [via our moodle page](https://moodle.unil.ch/mod/choicegroup/view.php?id=1023777). Because we do not now the final number of participants, we may create groups of 4 by the end of the grouping process. By default, only groups of 3 can register for the moment.
