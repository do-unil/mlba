...
- Learn about vesion-control with Git & GitHub
- Use R and Rstudio
...
- **Why Use Git?** Git is a version-control system that helps track changes, collaborate on projects, and revert to previous versions of a file.

![](../auxiliary/images/git_image.png){fig-align="center"}
...
<!-- ```{=html}
<iframe width="1000" height="400" src="https://do-unil.github.io/mlba/resources/beginners_r" data-external="1"></iframe>
``` -->
