...
```{r py-best-scores, echo=FALSE, include=FALSE}
...
Note that the accuracy of `r round(best_score,2)*100`% is on the training set. The best parameters are `r best_grid_param`. We will use a new plotting library for seeing this evolution called `seaborn`, which offers some great visualization tools.
