...
reticulate::py_install(c("jupyter", "pandas", "matplotlib","statsmodels","scikit-learn", "seaborn", "mlxtend", "lime", "mkl-service", "xgboost","scikit-learn-extra", "tensorflow", "keras", "torch", "torchvision"), envname = "MLBA", pip=TRUE)
```
